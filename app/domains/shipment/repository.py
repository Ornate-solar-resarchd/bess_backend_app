...
class ShipmentRepository:
    ...
    async def add_unit_to_shipment(self, db: AsyncSession, shipment_id: int, bess_unit_id: int) -> ShipmentItem:
        entity = ShipmentItem(shipment_id=shipment_id, bess_unit_id=bess_unit_id)
        db.add(entity)
        await db.flush()
        return entity
